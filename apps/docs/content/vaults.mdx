...
3. All conditions must be met, particularly staying above the **160% minimum collateralization ratio**
...
2. **Liquidation Mechanism:** If BTC's value drops and the collateralization ratio falls below the **135% liquidation threshold**, the vault can be liquidated to protect the system. This ensures XYM is always backed by real BTC, even in volatile markets.
