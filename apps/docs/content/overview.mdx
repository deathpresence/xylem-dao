...
1. **XYM** - The BTC-Overcollateralized debt token soft pegged to the USD
...
5. **Bitcoin Collateralized Debt Positions (BCDPs)** - BTC assets escrowed or 'vaulted' by users to mint & collateralize XYM
